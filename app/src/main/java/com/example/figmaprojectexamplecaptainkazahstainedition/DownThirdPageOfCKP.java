...
public class DownThirdPageOfCKP extends AppCompatActivity {

    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_down_third_page_of_ckp);
        findViewById(R.id.imgGoHome).setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                Intent switcher=new Intent(DownThirdPageOfCKP.this,MainActivity.class);
        ...
        findViewById(R.id.galleryPage).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent switcher=new Intent(DownThirdPageOfCKP.this,GalleryPageOfCKP.class);
                startActivity(switcher);
            ...
            public boolean onTouch(View v, MotionEvent touchEvent) {
                switch (touchEvent.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (y1 < y2 & yPanel == 0 & Math.abs(x1 - x2) < 150) {
                            Intent intent = new Intent(DownThirdPageOfCKP.this, FouthPageOfCKP.class);
