...
public class FifthPageOfCKP extends AppCompatActivity {
    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fifth_page_of_ckp);
        ...
        findViewById(R.id.imgGoHome).setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent switcher=new Intent(FifthPageOfCKP.this,MainActivity.class);
        ...
        findViewById(R.id.galleryPage).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent switcher=new Intent(FifthPageOfCKP.this,GalleryPageOfCKP.class);
                startActivity(switcher);
                ...
                switch(touchEvent.getAction()){
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (x1 > x2 & Math.abs(y1-y2)<150) {
                            Intent i = new Intent(FifthPageOfCKP.this, DownThirdPageOfCKP.class);
                            startActivity(i);
                            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                        }
                        else if (x1 < x2 & Math.abs(y1-y2)<150) {
                            Intent i = new Intent(FifthPageOfCKP.this, DownFirstPageOfCKP.class);
                            startActivity(i);
                            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                        }
                        else if (y1<y2 & yPanel==0 & Math.abs(x1-x2)<150){
                            Intent intent = new Intent(FifthPageOfCKP.this, ActivityThirdPageOfCkp.class);
